...
void heap051() {
    ...
    Heap<int> heap([](int& a, int& b) { return b - a; });
    heap.push(50);
    heap.push(20);
    heap.push(15);
    heap.push(10);
...
void heap068() {
    expect = "[1,2,6,4,5]\nLeak: 0";
    {
        ...
        try {
            ...
            heap.remove(&remove, [](Object* obj) { delete obj; }); // delete the object stored in heap, don't delete passed-in pointer
        }
        catch (underflow_error& e) {
            cout << e.what();
        }
...
void heap070() {
    expect = "Leak: 0";
    {
        ...
        for (int i = 0; i < n; ++i) heap.push(arr1[i]);
        heap.heapify(arr2, sizeof(arr2) / sizeof(arr2[0]));
    }
    cout << "Leak: " << Object::count;
}
...
void (*func_ptr[])() = {
    ...
    hash041, hash042, hash043, hash044, hash045, heap046, heap047, heap048, heap049, heap050,
    heap051, heap052, heap053, heap054, heap055, heap056, heap057, heap058, heap059, heap060,
    heap061, heap062, heap063, heap064, heap065, heap066, heap067, heap068, heap069, heap070,
    huffmantree071, huffmantree072, huffmantree073, huffmantree074, huffmantree075, huffmantree076, huffmantree077, huffmantree078, huffmantree079, huffmantree080,
    compressor081, compressor082, compressor083, compressor084, compressor085, compressor086, compressor087, compressor088, compressor089, compressor090,
};
